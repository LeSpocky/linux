...
static struct pci_device_id hfc4s8s_ids[] = {
	...
	/* QuirinVoice Old SubDevice ID */
	{.vendor = PCI_VENDOR_ID_CCD,
	 .device = PCI_DEVICE_ID_4S,
	 .subvendor = 0x1397,
	 .subdevice = 0xb527,
	 .driver_data =
	 (unsigned long) &((hfc4s8s_param) {CHIP_ID_4S, CLOCKMODE_1, 1,
				"QuirinVoice 1S miniPCI ISDN Board"}),
	},
	/* QuirinVoice New SubDevice ID */
	{.vendor = PCI_VENDOR_ID_CCD,
	 .device = PCI_DEVICE_ID_4S,
	 .subvendor = 0x1397,
	 .subdevice = 0xbb51,
	...
	{.vendor = PCI_VENDOR_ID_CCD,
	 ...
	 .subdevice = 0xbb52,
	 .driver_data =
	 (unsigned long) &((hfc4s8s_param) {CHIP_ID_4S, CLOCKMODE_1, 2,
				"QuirinVoice 2S miniPCI ISDN Board"}),
	},
       	{.vendor = PCI_VENDOR_ID_CCD,
	 .device = PCI_DEVICE_ID_4S,
	 .subvendor = 0x1397,
	 ...
	 .driver_data =
	 (unsigned long) &((hfc4s8s_param) {CHIP_ID_4S, CLOCKMODE_1, 4,
				"QuirinVoice 4S miniPCI ISDN Board"}),
	},
       	{.vendor = PCI_VENDOR_ID_CCD,
	 .device = PCI_DEVICE_ID_4S,
	 .subvendor = 0x1397,
	...
	{.vendor = PCI_VENDOR_ID_CCD,
	 ...
	 .driver_data =
	 (unsigned long) &((hfc4s8s_param) {CHIP_ID_4S, CLOCKMODE_1, 1,
				"QuirinVoice 1S PCIe ISDN Board"}),
	},
	{.vendor = PCI_VENDOR_ID_CCD,
	 .device = PCI_DEVICE_ID_4S,
	 .subvendor = 0x1397,
	 ...
	 .driver_data =
	 (unsigned long) &((hfc4s8s_param) {CHIP_ID_4S, CLOCKMODE_1, 2,
				"QuirinVoice 2S PCIe ISDN Board"}),
	},
	{.vendor = PCI_VENDOR_ID_CCD,
	 .device = PCI_DEVICE_ID_4S,
	 .subvendor = 0x1397,
	 ...
	 .driver_data =
	 (unsigned long) &((hfc4s8s_param) {CHIP_ID_4S, CLOCKMODE_1, 4,
				"QuirinVoice 4S PCIe ISDN Board"}),
	},
	{}
};
